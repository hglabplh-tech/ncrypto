...
(define list-te4-encr (list 
    #x63636363   #x7c7c7c7c   #x77777777   #x7b7b7b7b  
...
(define rcon (list
    ...
    #x1B000000  #x36000000  ;; for 128-bit blocks  Rijndael never  ses more than 10 rcon val es 
))